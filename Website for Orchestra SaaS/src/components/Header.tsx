      ...
      >
        <div className="max-w-7xl mx-auto px-5 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-3">
            <button className="text-sm text-zinc-600 hover:text-zinc-900 transition-colors px-3 py-2">
              Entrar
            </button>
            <button
              onClick={onDemo}
          ...
          <div className="absolute top-16 left-0 right-0 bg-white border-b border-zinc-200 shadow-xl">
            <nav className="px-4 py-3 flex flex-col gap-1">
              ...
              <div className="pt-3 border-t border-zinc-100 mt-2 flex flex-col gap-2">
                <button className="text-sm text-zinc-600 px-4 py-3 text-left hover:bg-zinc-50 rounded-lg transition-colors">
                  Entrar
                </button>
                <button
