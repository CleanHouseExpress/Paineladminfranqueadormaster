...
interface TenantContextValue {
  ...
  /** Hydrate tenant data from the current host/subdomain */
...
export function TenantProvider({ children }: { children: React.ReactNode }) {
  ...
  return (
    <TenantContext.Provider value={{ tenant, isTenantLoading, tenantExists, tenantError, isModuleEnabled, isModuleBlocked, updateWhiteLabel, setModuleEnabled, hydrateTenant, loadCurrentTenant }}>
      {children}
