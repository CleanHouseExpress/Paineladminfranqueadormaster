...
export function CommunicationInboxPage() {
  ...
  return (
    ...
    <main className="flex h-full min-h-0 flex-col bg-slate-50" data-testid="communication-inbox-page">
      <section className="px-4 py-3">
        <div className="grid grid-cols-1 gap-3 rounded-lg border border-slate-200 bg-white p-3 md:grid-cols-2 xl:grid-cols-[minmax(220px,1fr)_170px_170px_170px_auto_auto]">
          ...
          <div className="relative flex items-end">
            <button
              type="button"
              onClick={() => setSummaryPanelOpen(current => !current)}
              ...
              data-testid="communication-inbox-summary"
            >
              <Inbox className="h-4 w-4" />
              Resumo
            </button>
            {summaryPanelOpen && (
              <div className="absolute right-0 top-12 z-20 w-64 rounded-lg border border-slate-200 bg-white p-3 shadow-lg">
          ...
          <div className="flex items-end gap-2">
            <div
              ...
              title={realtimeAvailable ? 'Tempo real ativo' : 'Offline / tempo real indisponivel'}
            >
              <span className={`h-2 w-2 rounded-full ${realtimeAvailable ? 'bg-emerald-500' : 'bg-slate-400'}`} />
              {realtimeAvailable ? 'Online' : 'Offline'}
            </div>
            <button
              type="button"
              onClick={() => {
              ...
              className="inline-flex h-10 items-center justify-center rounded-md border border-slate-300 bg-white px-3 text-slate-700 hover:bg-slate-50"
      ...
      <section className="grid min-h-0 flex-1 grid-cols-1 gap-4 px-4 pb-4 xl:grid-cols-[340px_minmax(0,1fr)] 2xl:grid-cols-[380px_minmax(0,1fr)]">
              ...
              <div className="border-b border-slate-200 px-4 py-3">
                <div className="flex items-center justify-between gap-3">
                  ...
                  <div className="relative flex flex-shrink-0 items-center gap-2">
                    <div className="hidden flex-wrap justify-end gap-1.5 text-[11px] font-medium sm:flex">
                    ...
                    <button
                      ...
                      aria-label="Abrir acoes da conversa"
                      title="Acoes"
                    >
                      <MoreHorizontal className="h-4 w-4" />
                    </button>
                    {conversationMenuOpen && (
                      <div className="absolute right-0 top-11 z-30 w-64 rounded-lg border border-slate-200 bg-white p-2 shadow-lg" data-testid="communication-actions">
                        <button
                          type="button"
                          onClick={() => {
                            setActiveConversationTab('messages');
                        ...
                        >
                          Mensagens
                          {activeConversationTab === 'messages' && <span className="text-xs">Ativo</span>}
                        </button>
                        <button
                          type="button"
                          onClick={() => {
                            setActiveConversationTab('timeline');
                            setConversationMenuOpen(false);
                          }}
                          className={`flex w-full items-center justify-between rounded-md px-3 py-2 text-left text-sm font-medium ${
                            activeConversationTab === 'timeline'
                        ...
                        >
                          Timeline
                          {activeConversationTab === 'timeline' && <span className="text-xs">Ativo</span>}
                        </button>
                        <button
                          type="button"
                          onClick={() => {
                          ...
                          data-testid="communication-open-details"
                        >
                          Informacoes
                        </button>
                        ...
                        {canAssign && (
                          <button
                            ...
                            onClick={() => {
                              setConversationMenuOpen(false);
                              selectedConversationId && void runConversationAction(() => assignMutation.mutate(selectedConversationId));
                            }}
                            className="w-full rounded-md px-3 py-2 text-left text-sm font-medium text-blue-700 hover:bg-blue-50 disabled:cursor-not-allowed disabled:opacity-60"
                        ...
                        {canRequestHandoff && (
                          <button
                            ...
                            onClick={() => {
                              setConversationMenuOpen(false);
                              selectedConversationId && void runConversationAction(() => requestHandoffMutation.mutate(selectedConversationId));
                            }}
                            className="w-full rounded-md px-3 py-2 text-left text-sm font-medium text-amber-700 hover:bg-amber-50 disabled:cursor-not-allowed disabled:opacity-60"
                        ...
                        {canClose && (
                          <button
                            ...
                            className="w-full rounded-md px-3 py-2 text-left text-sm font-medium text-slate-700 hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-60"
                            data-testid="communication-action-close"
                          >
                            {closeMutation.isLoading ? 'Fechando...' : 'Fechar atendimento'}
                          </button>
                        )}
                        {canReturnToAi && (
                          <button
                            ...
                            className="w-full rounded-md px-3 py-2 text-left text-sm font-medium text-violet-700 hover:bg-violet-50 disabled:cursor-not-allowed disabled:opacity-60"
                            data-testid="communication-action-return-ai"
                          >
                            {returnToAiMutation.isLoading ? 'Retornando...' : 'Voltar IA'}
                          </button>
                        )}
                        {canReopen && (
                          <button
                            ...
                            onClick={() => {
                              setConversationMenuOpen(false);
                              selectedConversationId && void runConversationAction(() => reopenMutation.mutate(selectedConversationId));
                            }}
                            className="w-full rounded-md px-3 py-2 text-left text-sm font-medium text-emerald-700 hover:bg-emerald-50 disabled:cursor-not-allowed disabled:opacity-60"
      ...
      {conversationDetailsOpen && (
        <div className="fixed inset-0 z-40 flex justify-end bg-slate-950/30" data-testid="communication-conversation-details">
          <aside className="flex h-full w-full max-w-md flex-col bg-white shadow-xl">
            <div className="flex items-center justify-between border-b border-slate-200 px-4 py-3">
              <div className="flex items-center gap-2">
                <UserRound className="h-4 w-4 text-slate-500" />
                <h2 className="text-sm font-semibold text-slate-950">Informacoes</h2>
              </div>
              <button
                type="button"
