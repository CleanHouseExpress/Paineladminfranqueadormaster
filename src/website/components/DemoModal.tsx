...
export default function DemoModal({ open, onClose }: DemoModalProps) {
  ...
  useEffect(() => {
    if (!open) { setTimeout(() => setPrepared(false), 300) }
  }, [open])
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div
        className="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden animate-fade-up"
        role="dialog"
        aria-modal="true"
      ...
      >
        <div className="bg-gradient-to-br from-indigo-600 to-indigo-700 px-8 py-7">
          ...
          <h2 id="demo-modal-title" className="text-xl font-bold text-white mb-1" style={{ fontFamily: 'Manrope, sans-serif' }}>
            Solicitar demonstração
          </h2>
          <p className="text-indigo-200 text-sm">
            Preencha os dados para preparar a solicitação.
          </p>
        </div>
        ...
        {prepared ? (
          <div className="px-8 py-12 text-center">
            ...
            <p className="text-sm text-zinc-500">
              O envio automatico ainda nao esta conectado a um endpoint. Use o canal comercial da Orchestra para concluir o contato.
            </p>
            <button
              onClick={onClose}
