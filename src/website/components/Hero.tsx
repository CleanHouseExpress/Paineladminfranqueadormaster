        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className={`space-y-7 transition-all duration-700 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2">
              ...
              <a
                href="#plataforma"
                className="inline-flex items-center justify-center gap-2 bg-white hover:bg-zinc-50 text-zinc-700 font-semibold px-6 py-3.5 rounded-xl text-sm border border-zinc-200 transition-all duration-150 no-underline"
              >
